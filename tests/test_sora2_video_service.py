...
class Sora2VideoServiceTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_token_pool_task_failure_rebuilds_task_within_configured_limit(self):
        mod = _load_module()
        calls = []
    ...
    async def test_non_token_task_failure_is_not_rebuilt(self):
        mod = _load_module()
        calls = []
            ...
            async def _request_json_with_retries(self, *args, **kwargs):
                ...
                return {
                    ...
                    "error": {
                        ...
                        "message": "No available channel for model video-2.0-pro",
                    },
                }
